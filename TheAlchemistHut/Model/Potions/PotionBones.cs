...
{
    public class PotionBones : IPotion, IItems
    {
        ...
        public PotionBones()
        {
            FirstIngredient = "Перец";
            SecondIngredient = "Рыба";
            ThirdIngredient = "Спук";
            Height = 32;
            Width = 32;
            Name = "зелье костерост";
            ItemImg = Image.FromFile("Textures/Potions/potionBones.png");
            Ingredients = new List<IItems> { new ItemPepper(), new ItemFish(), new ItemSpook() };
        }
    }
}
