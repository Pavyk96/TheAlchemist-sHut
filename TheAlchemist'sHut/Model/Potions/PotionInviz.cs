...
{
    public class PotionInviz : IPotion, IItems
    {
        ...
        public PotionInviz()
        {
            ...
            ItemImg = Image.FromFile("Textures/Potions/potionInviz.png");
            Ingredients = new List<IItems> { new ItemGelatine(), new ItemMane(), new ItemPepper() };
        }
    }
}
